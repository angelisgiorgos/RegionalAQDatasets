...
from src.utils.print_args import print_args
...
def arguments():
    ...
    parser.add_argument('--station_name', type=str, default='MAROUSI')
    # data loader
    ...
    parser.add_argument('--start_adjusting', type=int, default=10, help='start adjusting lr')
