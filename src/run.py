...
def arguments():
    ...
    parser.add_argument('--station_name', type=str, default='Athens CAMS station 0')
    # data loader
    parser.add_argument('--data', type=str, default='air', help='dataset type')
    parser.add_argument('--root_path', type=str, default='D:/github-repos/AQ_Datasets/time-series',
                        help='root path of the data file')
    parser.add_argument('--data_path', type=str, default='athens.csv', help='data file')
    parser.add_argument('--features', type=str, default='MS',
                        help='forecasting task, options:[M, S, MS]; M:multivariate predict '
                             ...
                             'predict univariate')
    parser.add_argument('--covariates', type=list, default=['Temp', 'Soil Temp',
                                                            'Total Percipitation', 'Wind-Speed (U)','Wind-Speed (V)',
                                                            'Dewpoint Temp'])
    parser.add_argument('--target', type=str, default='NO2', help='target feature in S or MS task')
    ...
    parser.add_argument('--factor', type=int, default=6, help='attn factor')
    parser.add_argument('--distil', action='store_false',
                        help='whether to use distilling in encoder, using this argument means not '
                             'using distilling',
                        default=True)
    ...
    parser.add_argument('--start_adjusting', type=int, default=3, help='start adjusting lr')
    ...
    parser.add_argument('--use_dtw', type=bool, default=False,
                        help='the controller of using dtw metric (dtw is time consuming, '
                             'not suggested unless necessary)')
